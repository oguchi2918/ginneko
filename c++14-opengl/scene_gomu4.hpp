#ifndef INCLUDED_SCENE_GOMU4_HPP
#define INCLUDED_SCENE_GOMU4_HPP
...
private:
  ...
  nekolib::renderer::Program update_prog_; // 位置更新用計算シェーダー
  nekolib::renderer::Program update_end_prog_; // 両端の位置更新用計算シェーダー
...
#endif // INCLUDED_SCENE_GOMU4_HPP
